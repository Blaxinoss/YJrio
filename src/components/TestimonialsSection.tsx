...
const testimonials: Testimonial[] = [
  {
    id: 'testimonial-1',
    quote: "The true crime documentary series produced was both sensitive to the victims and riveting in its storytelling. Exceptional work that brought new attention to our cold case.",
  ...
  {
    id: 'testimonial-2',
    quote: "Our streaming event reached over 200,000 viewers thanks to the professional production quality and engaging narrative structure. We couldn't be happier with the results.",
    name: "Michael Chen",
  ...
  {
    id: 'testimonial-3',
    quote: "The documentary not only told our story but created real impact. After it aired, our environmental initiative saw a 300% increase in volunteer sign-ups and donations.",
