      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            <a href="#" className="text-2xl font-bold text-gradient mb-4 block">STORY<span className="text-filmmaker-red">LENS</span></a>
            <p className="text-gray-400 mb-6 max-w-md">
              Crafting compelling visual narratives that inspire, inform, and immerse viewers in 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span>contact@storylens.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {currentYear} StoryLens Films. All rights reserved.
          </p>
